...
def config_parser():
    ...
    Returns:
        parser: use to parse command line arguments
    """
    ...
    parser.add_argument("--eikonal", action='store_true', 
                        help='use eikonal fields method')
    ...
    parser.add_argument("--no_reload", default=False, action='store_true', 
    ...
    parser.add_argument("--i_data",    type=int, default=1000, 
                        help='frequency of figure points (iter, loss, psnr) saving')
    ...
    ## eikonal options
    parser.add_argument("--iters_eikonal", type=int, default=5000, 
                        help='number of training iterations')
    parser.add_argument("--i_print_eikonal",   type=int, default=100, 
                        help='frequency of console printout and metric loggin')
    parser.add_argument("--i_img_eikonal",     type=int, default=100, 
                        help='frequency of tensorboard image logging')
    parser.add_argument("--i_weights_eikonal", type=int, default=500, 
                        help='frequency of weight ckpt saving')
...
if __name__=="__main__":
    ...
    train(args)
    if args.eikonal == True and args.dataset_type == 'llff':
        find_box(args)